...
The [provider-netbird](https://github.com/infitx-org/netbird-crossplane-provider) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/infitx-org/netbird-crossplane-provider/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/infitx-org/netbird-crossplane-provider/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/infitx-org/netbird-crossplane-provider/blob/main/hack/boilerplate.go.txt](https://github.com/infitx-org/netbird-crossplane-provider/blob/main/hack/boilerplate.go.txt)
...
The [provider-netbird](https://github.com/infitx-org/netbird-crossplane-provider)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/infitx-org/netbird-crossplane-provider/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/infitx-org/netbird-crossplane-provider/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue netbirds (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/infitx-org/netbird-crossplane-provider/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Netbirds: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/infitx-org/netbird-crossplane-provider/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
